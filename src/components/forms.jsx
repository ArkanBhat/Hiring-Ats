...
export function InterviewForm({ c, patch, flash, onScheduled }) {
  ...
  return (
    <div className="form-grid">
      ...
      <label>Interviewer email(s)<input type="email" multiple value={d.interviewerEmail} onChange={(e) => setD({ ...d, interviewerEmail: e.target.value })} placeholder="Optional — comma-separate for multiple, sends them an invite too" /></label>
      {d.mode === "Phone" ? (
